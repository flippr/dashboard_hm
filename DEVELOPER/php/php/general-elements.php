						...
						<div class="row">
							...
							<div class="col-sm-12">
								<p class="alert alert-info">
									<i class="fa fa-info"></i> Did you know you can add more than just the basic colors to customize your badge? <strong>Learn more about color options modifiers on the <a href="<?php echo APP_URL; ?>/typography.html">Typography page</a>! </strong>
								</p>
								<!-- row -->
								<div class="row">
						...
						<div class="col-sm-12 col-md-12 col-lg-6">
							...
							<div class="well">
								...
								<ul class="demo-btns text-center">
									...
									<li>
										<a href="javascript:void(0);" class="btn btn-default btn-lg" rel="tooltip" data-placement="top" data-original-title="<img src='img/avatars/mcdonalds.png' alt='me' class='online'>" data-html="true">also Image</a>
									</li>
								</ul>
