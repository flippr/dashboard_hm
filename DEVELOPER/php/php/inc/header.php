...
<header id="header">
    <div id="logo-group">
        ...
        <span id="logo"> <img src="<?php echo ASSETS_URL; ?>/img/logo.png" alt="SmartAdmin" width="23%" height="23%" > </span>
        ...
        <ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
            <li class="">
                <a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown">
                    <img src="<?php echo ASSETS_URL; ?>/img/avatars/mcdonalds.png" alt="McDonalds" class="online" />
                </a>
