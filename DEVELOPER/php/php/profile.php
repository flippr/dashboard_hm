...
$page_nav["misc"]["sub"]["others"]["sub"]["profile"]["active"] = true;
include("inc/nav.php");
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12 col-lg-6">
								...
								<div class="chat-body no-padding profile-message">
									<ul>
										<li class="message">
											<img src="<?php echo ASSETS_URL; ?>/img/avatars/mcdonalds.png" class="online">
											<span class="message-text"> <a href="javascript:void(0);" class="username">McDonalds <small class="text-muted pull-right ultra-light"> 2 Minutes ago </small></a> Can't divide were divide fish forth fish to. Was can't form the, living life grass darkness very
