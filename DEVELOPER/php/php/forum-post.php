				...
				<div class="well">
					...
					<table class="table table-striped table-forum">
						...
						<tbody>
							<!-- Post -->
							<tr>
								<td class="text-center"><a href="<?php echo APP_URL; ?>/profile.php"><img alt="" src="<?php echo ASSETS_URL; ?>/img/flags/us.png"> &nbsp; <strong>McDonalds</strong></a></td>
								<td>on <em>Jan 1, 2014 - 12:00am</em></td>
							</tr>
							<tr>
								<td class="text-center" style="width: 12%;">
								<div class="push-bit">
									<a href="<?php echo APP_URL; ?>/profile.php"> <img src="<?php echo ASSETS_URL; ?>/img/avatars/mcdonalds.png" width="50" alt="avatar" class="online"> </a>
