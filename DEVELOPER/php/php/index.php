                                ...
                                <div class="row no-space">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 show-stats">
                                        ...
                                        <div class="row">
                                            ...
                                            <span class="show-stat-buttons"> <span class="col-xs-12 col-sm-6 col-md-6 col-lg-6"> <a href="javascript:void(0);" class="btn btn-default btn-block hidden-xs">Generate
                                                                                                                                                                                                           PDF</a> </span> <span class="col-xs-12 col-sm-6 col-md-6 col-lg-6"> <a href="javascript:void(0);" class="btn btn-default btn-block hidden-xs">Report
                                                                                                                                                                                                                                                                                                                                                         a
                                                                                                                                                                                                                                                                                                                                                         bug</a> </span> </span>
                    ...
                    <div id="chat-container">
                        ...
                        <div class="chat-list-body custom-scroll">
                            <ul id="chat-users">
                                ...
                                <li>
                                    <a href="javascript:void(0);"><img src="<?php echo ASSETS_URL; ?>/img/avatars/mcdonalds.png" alt="">Sunny <span class="state"><i class="last-online pull-right">2m</i></span> </a>
                                </li>
                                <li>
                        ...
                        <ul>
                            ...
                            <li class="message">
                                ...
                                <div class="message-text">
                                    ...
                                    <a href="javascript:void(0);" class="username">McDonalds</a> Haha! Yeah I know what you mean. Thanks for the file Sadi! <i class="fa fa-smile-o txt-color-orange"></i>
                                </div>
                            </li>
                        </ul>
            ...
            <div class="widget-body no-padding smart-form">
                ...
                <ul id="sortable2" class="todo">
                    ...
                    <li>
                        ...
                        <p>
                            <strong>Ticket #1314</strong> - Call customer support re: Issue <a href="javascript:void(0);" class="font-xs">#6134</a>
